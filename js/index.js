        ...
        const showMeme = () => {
            clearAll();
            document.querySelector(".meme").setAttribute("src", rn(memes));
        }

        const showJoke = () => {
            clearAll();
            document.querySelector(".joke").textContent = rn(jokes);
        }

        const showQuote = () => {
            clearAll();
            document.querySelector(".quote").textContent = rn(quotes).quote;
            document.querySelector(".author").textContent = "-" + rn(quotes).author;
        }

        const showRiddle = () => {
            clearAll();
            document.querySelector(".question").textContent = rn(riddles).question;
            document.querySelector(".answer").textContent = rn(riddles).answer;
        ...
        const revealAnswers = () => {
            ...
            if(question.innerHTML.length != 0 && answer.style.visibility === "hidden"){
                answer.style.visibility = "visible";
            }

            else if(question.innerHTML.length != 0 && answer.style.visibility === "visible"){
                alert("The riddle's answer is already revealed!")
            }
            else{
        ...
        const clearAll = () => {
            document.querySelector(".meme").setAttribute("src", "");
